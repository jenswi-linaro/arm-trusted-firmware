...
#define ARM_MAP_SPCI_MSG_BUFS_NSEC	MAP_REGION_FLAT(			\
...
#if ENABLE_SPCI_ALPHA2
#define SPCI_MSG_BUFS_NSEC_START	BL31_LIMIT
#define SPCI_MSG_BUFS_NSEC_SIZE		(PLAT_SPM_MAX_PARTITIONS * 2 * PAGE_SIZE)
