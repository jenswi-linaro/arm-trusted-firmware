...
#ifndef SPCI_ALPHA2_H
#define SPCI_ALPHA2_H
...
#ifndef __ASSEMBLY__
/* SPCI Alpha2 messages related defines */
...
//CASSERT(PAGE_SIZE >= sizeof(spci_buf_t), assert_spci_buf_overflows);
...
#define SPCI_MEM_REG_ARCH_TYPE_MASK     U(0x3)
...
#define SPCI_BUF_TABLE_ATTR(cnt, gran)                  \
	(SPCI_SPCI_BUF_TABLE_ATTR_GRAN(gran)    |       \
	 SPCI_BUF_TABLE_ATTR_PGCNT(type))
